                    ...
                    <div className="container">
                        <div className="row gy-3 align-items-center">
                            ...
                            <div className="col-lg-2 col-sm-4 col-4">
                                <NavLink to="/" className={"nav-link"}><img src={logo} height={35} alt="logo" className="pe-2" />Meoww</NavLink>
                            </div>
                            {/* Left elements */}
                            ...
                            <div className="order-lg-last col-lg-5 col-sm-8 col-8">
                                <div className="d-flex float-end">
                                    <NavLink to="/signin" className={"nav-link me-1 border rounded py-1 px-3 nav-link d-flex align-items-center"}>
                                    ...
                                    <NavLink to="/signin" className={"border rounded py-1 px-3 nav-link d-flex align-items-center"}>
                            ...
                            <div className="col-lg-5 col-md-12 col-12">
                                <div className="input-group float-center">
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-primary shadow-0" type="button" id="button-addon2"><i className="fas fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                            {/* Right elements */}
                    ...
                    <div className="container justify-content-center justify-content-md-between">
                        ...
                        <div className="collapse navbar-collapse" id="navbarLeftAlignExample">
                            ...
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <NavLink to="/hotoffers" className={"nav-link"}>Hot offers</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/gift" className={"nav-link"}>Gift boxes</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/projects" className={"nav-link"}>Projects</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/menuitem" className={"nav-link"}>Menu item</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/menuname" className={"nav-link"}>Menu name</NavLink>
                                </li>
                                {/* Navbar dropdown */}
