            ...
            <div className="card mb-4 border shadow-0">
              <div className="p-4 d-flex justify-content-between">
                ...
                <div className="d-flex align-items-center justify-content-center flex-column flex-md-row">
                  <button className="btn btn-outline-primary me-0 me-md-2 mb-2 mb-md-0 w-100">
                    Register
                  </button>
                  <button className="btn btn-primary shadow-0 text-nowrap w-100">
                    Sign in
                  </button>
                </div>
              </div>
              ...
              <div className="d-flex align-items-center mb-4">
                <div className="me-3 position-relative">
                  <img
                    ...
                    className="img-sm rounded border img-product"
                    alt="product"
                  />
