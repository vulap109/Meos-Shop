              ...
              <header className="d-sm-flex align-items-center border-bottom mb-4 pb-3">
                ...
                <div className="ms-auto">
                  ...
                  <div className="btn-group shadow-0 border">
                    <NavLink to="" className="btn btn-light" title="List view">
                      <i className="fa fa-bars fa-lg"></i>
                    </NavLink>
                    <NavLink to="/" className="btn btn-light" title="Grid view">
                      ...
                      <div className="row g-0">
                        ...
                        <div className="col-xl-6 col-md-5 col-sm-7">
                          ...
                          <p className="text mb-4 mb-md-0">
                            Short description about the product goes here, for
                            ex its features. Lorem ipsum dolor sit amet with
                            hapti you enter into any new area of science, you
                            almost lorem ipsum is great text consectetur
                            adipisicing
                          </p>
                        </div>
                    ...
                    <div className="card-body">
                      <div className="row g-0">
                        ...
                        <div className="col-xl-6 col-md-5 col-sm-7">
                          ...
                          <p className="text mb-4 mb-md-0">
                            Re-engineered Digital Crown with hapti Lorem ipsum
